...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("☎️𝐖𝐎𝐎𝐃𝐜𝐫𝐚𝐟𝐭", url = "https://t.me/CimraanKhaan")
    ],[
        InlineKeyboardButton('🔍 WD Topic Group', url='https://t.me/khaaanfilms'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/khaan_films')
	]]
